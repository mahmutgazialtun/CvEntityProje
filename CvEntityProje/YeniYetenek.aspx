...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h4 style="margin-left:20px;">YENİ YETENEK EKLEME SAYFASI</h4>
    <br />
    <asp:Label ID="Label1" runat="server" Text="Yetenek Açıklama"></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox> <%-- placeholder içine yetenek açıklama da yazılabilir--%>
    <br />
